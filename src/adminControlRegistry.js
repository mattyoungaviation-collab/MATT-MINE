...
const STATIC_CONTROLS = Object.freeze([
  ...
  entry('nugget-economy', 'economy:practice-claims', 'Practice reward claims', 'Configure exact paid Practice claim pricing and limits.', 'Nugget economy'),
  ...
  entry('nugget-economy', 'economy:practice-price', 'Practice claim price', 'Payment asset and exact token amount for a paid Practice claim.', 'Nugget economy'),
  ...
  entry('rewards', 'rewards:create', 'Create weekly MATT reward draft', 'Build an immutable Free or Pass reward draft for a finalized week.', 'Rewards'),
  entry('rewards', 'rewards:approve', 'Approve MATT reward draft', 'Independent review and approval before an epoch can be published.', 'Rewards'),
  entry('rewards', 'rewards:publish', 'Publish MATT reward epoch', 'Prepare the approved Merkle root and full claim allocation for Ronin.', 'Rewards'),
  entry('rewards', 'rewards:sync', 'Synchronize MATT reward transaction', 'Confirm the published onchain epoch after its transaction is mined.', 'Rewards'),
