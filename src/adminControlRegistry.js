...
const STATIC_CONTROLS = Object.freeze([
  ...
  entry('operations', 'operations:mine-practice', 'Practice Mine operations', 'Pause Practice entries, result submission, payments, or rewards independently.', 'Mine Operations'),
