...
function injectStyles() {
  ...
  style.textContent = `
    .nugget-shop-panel { max-height: min(92vh, 980px); overflow: auto; }
    .nugget-package-grid { margin-top: 1.25rem; }
    .nugget-package-card { min-height: 0; }
    .nugget-package-actions { display: grid; gap: .65rem; margin-top: 1rem; }
    .nugget-package-actions button:disabled { opacity: .55; cursor: not-allowed; }
    .nugget-history-panel { margin-top: 1.25rem; }
    .nugget-history-panel a { color: inherit; text-decoration: underline; }
    @media (max-width: 760px) {
      .nugget-shop-panel { max-height: 96vh; }
