...
const ENDLESS_ADMIN_FIELDS = Object.freeze([
  ...
  ['Entry limits', 'entry.entriesPerMiner', 'Entries per Miner (0 = unlimited)', 'integer', 0, 1_000_000],
  ['Entry limits', 'entry.resetPeriodHours', 'Entry reset period (hours)', 'integer', 1, 8_760],
  ['Entry limits', 'entry.resetUtcHour', 'Reset anchor hour (UTC)', 'integer', 0, 23],
  ['Entry limits', 'entry.cooldownSeconds', 'Wallet cooldown between entries (seconds)', 'integer', 0, 604_800],
  ['Entry limits', 'entry.maximumActiveRunsPerWallet', 'Maximum active runs per wallet', 'integer', 1, 100],
  ['Entry limits', 'entry.minimumMinerLevel', 'Minimum Miner level', 'integer', 1, 1_000],
  ['Entry limits', 'entry.abandonedRunsConsumeEntry', 'Abandoned runs consume an entry', 'boolean', 0, 1],
  ...
  ['Integrity', 'integrity.maximumEventsPerPhase', 'Maximum outcome events per phase', 'integer', 100, 100_000],
  ['Integrity', 'integrity.maximumInputEventsPerPhase', 'Maximum raw input events per phase', 'integer', 100, 1_000_000],
  ['Integrity', 'integrity.inputClockToleranceSeconds', 'Input clock tolerance seconds', 'integer', 1, 60],
