...
export const EXPANSION_SCHEMA = Object.freeze([
  ...
  field('deathRetentionPractice', 'Death and Revives', 'Practice retention percent', 'number', 50, 0, 100, 'Applied with floor rounding.'),
  field('deathRetentionFree', 'Death and Revives', 'Free retention percent', 'number', 50, 0, 100, 'Applied with floor rounding.'),
  field('deathRetentionPaid', 'Death and Revives', 'Pass retention percent', 'number', 50, 0, 100, 'Applied with floor rounding.'),
  ...
  field('controllerDeadZone', 'Controller Defaults', 'Stick dead zone', 'number', .18, 0, .5, 'Input below this radius is ignored.'),
  field('controllerAimSensitivity', 'Controller Defaults', 'Aim sensitivity', 'number', 1, .25, 3, 'Right-stick aiming multiplier.'),
  field('controllerVibration', 'Controller Defaults', 'Vibration enabled', 'boolean', true, 0, 1, 'Players may override this in their profile.'),
